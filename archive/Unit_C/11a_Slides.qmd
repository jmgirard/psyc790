...
- Last week, we learned about multiple regression
...
library(ggeffects)
plot(predict_response(fit, terms = c("duration", "intensity")))
```
...
library(ggeffects)
plot(predict_response(fit, terms = c("duration", "intensity"))) + mytheme(24)
```
...
plot(predict_response(fit, terms = c("intensity", "duration")))
```

```{r}
#| echo: false

plot(predict_response(fit, terms = c("intensity", "duration"))) + mytheme(24)
```
...
plot(predict_response(fit2, terms = c("duration", "intensity")))
```

```{r}
#| echo: false

plot(predict_response(fit2, terms = c("duration", "intensity"))) + mytheme(24)
```
...
plot(predict_response(fit2, terms = c("intensity", "duration")))
```

```{r}
#| echo: false

plot(predict_response(fit2, terms = c("intensity", "duration"))) + mytheme(24)
```
...
fit0 <- lm(y ~ x1 * x2, d)
plot(predict_response(fit0, terms = c("x1", "x2[-1,0,1]"))) + 
  mytheme(20) + 
...
plot(predict_response(fit3, terms = c("duration_c", "intensity_c")))
```

```{r}
#| echo: false

plot(predict_response(fit3, terms = c("duration_c", "intensity_c"))) + mytheme(24)
```
...
plot(predict_response(fit3, terms = c("intensity_c", "duration_c")))
```

```{r}
#| echo: false

plot(predict_response(fit3, terms = c("intensity_c", "duration_c"))) + mytheme(24)
```
