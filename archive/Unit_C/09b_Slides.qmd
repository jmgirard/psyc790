...
Regression / Inference / Centering
...
parenthood <- read_csv("parenthood.csv", show_col_types = FALSE)
...
#| echo: false
water <- read_csv("water.csv")
knitr::kable(water) |> kableExtra::scroll_box(height="400px")
```
...
library(ggeffects)
est <- predict_response(fit, "hardness")
...
["A town with *zero* water hardness<br>would have 1676.356 mortality."]{.f5}
:::
::: {.column .tc}
```{r, fig.width=5, fig.height=3}
...
["A town with *average* water hardness<br>would have 1524.148 mortality."]{.f5}
:::
:::
