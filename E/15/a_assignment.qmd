...
Find a published research paper in your own area that used multiple regression, and evaluate it from the perspective of a methodological reviewer rather than as an ordinary reader. Write up a summary of what you found regarding the **introduction and methods** sections. (Pick a paper you can access in full, including its tables.)
