...
a) I want to test whether the three types of occupation (`type`, i.e., Blue Collar, White Collar, and Professional) have different mean `prestige` scores.{{< hp glyph="a" >}} What should my null and alternative hypotheses be? What are the two components of variation in this data (give the technical names and describe what they are verbally)?
