...
- The sum of squared *standard* normal values will have a $\chi^2$ distribution

- The ratio of two independent $\chi^2$ variables, *each divided by its df*, will have an $F$ distribution (this is why $F$ uses $MS = SS/\textit{df}$)
...
::: {.footer}
Because equality is transitive, no other combinations are possible (e.g., if $\mu_1=\mu_3$ and $\mu_2=\mu_3$, then $\mu_1=\mu_2$)
:::
