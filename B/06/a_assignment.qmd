...
Download and use the `salaries` data file for this question. (Note that the salaries are given in thousands of dollars per year, such that 120 would actually mean $120,000 per year.)
...
Download and use the `salaries` data file for this question as well. This time, test the null hypothesis that professors make, on average, $110,000 per year.
