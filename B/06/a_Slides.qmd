...
- If we ignore these relationships in our modeling...
    ...
    + Therefore, our $p$-values and CIs will be incorrect, costing power

## Paired samples $t$-test {.fs90}
...
Patients' social problems were 0.42 units (or 0.66 change-score standard deviations) lower at the endpoint compared to baseline.
