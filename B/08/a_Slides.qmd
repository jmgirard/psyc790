...
- The ANOVA we learned in the previous chapter used Student's approach
...
::: {.fs90}
1. Can you walk through a worked example of [method] again?

2. What's the difference between [concept A] and [concept B]?

3. How do I know when to use [method] versus [alternative]?

4. Could you clarify a step in the [workflow / process]?

5. Can we revisit how to interpret results from [method]?

6. What are common mistakes or misconceptions about [topic]?
:::
