...
::: {.section-art}
{{< lif "../../icons/scales.json" colors=secondary:#2a76dd class=rc >}}
:::
...
::: {.section-art}
{{< lif "../../icons/flowchart.json" colors=secondary:#2a76dd class=rc >}}
:::
...
2. [Reject the null hypothesis]{.b .blue}
    ...
    + The cereal's nutrion label should be changed...
...
- If we set $\alpha$ to .05, we are accepting...
    + Up to a 5% (1 in 20) chance of rejecting a true null hyp.
:::

::: {.fragment}
- If we use a sample with 80% power, we are accepting...
    + Up to a 20% (1 in 5) chance of retaining a false null hyp.
:::
...
::: {.section-art}
{{< lif "../../icons/wrench.json" colors=secondary:#2a76dd class=rc >}}
:::
...
::: {.section-art}
{{< lif "../../icons/threshold.json" colors=secondary:#2a76dd class=rc >}}
:::
