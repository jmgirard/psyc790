...
A script holds many lines of code, which allows for longer and more complex work.
Think of it like drafting an email with many instructions rather than shouting one
at a time.
