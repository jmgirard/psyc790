...
## R and Other Stats Software {.fs70}
...
-   R is a [real programming language]{.b .green}, not a menu with a syntax window
    -   Which is why [data preparation]{.b .blue} is so much easier here
    -   Cleaning, reshaping, and merging are the bulk of real analysis
:::

::: {.fragment .mt1}
-   New methods arrive as [packages]{.b .blue}, written by the researchers who
    developed them, often years before the commercial packages catch up
:::
