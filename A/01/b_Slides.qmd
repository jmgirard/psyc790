...
10 x 3 # Error: R has no x operator; use *
```
...
10 \ 3 # Error: the slash leans the other way
```
...
# R drops zeros that carry no information
09.870
```
...
9,876,543 # Error: no commas

9 876 543 # Error: no spaces either
```

::: aside
*Note.* Separators are for humans reading a page, not for R. Type the digits and nothing else.
:::
