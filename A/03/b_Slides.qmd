...
::: {.section-art}
{{< lif "../../icons/data_frame.json" colors=secondary:#2a76dd class=rc >}}
:::
...
name. They must be equal length: these are rows of one table.
:::
...
::: {.section-art}
{{< lif "../../icons/explore.json" colors=secondary:#2a76dd class=rc >}}
:::
