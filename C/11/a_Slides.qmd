...
library(modelbased)
plot(estimate_relation(fit, by = c("duration", "intensity=[sd]"))) + mytheme(24)
```
...
plot(estimate_relation(fit, by = c("intensity", "duration=[sd]"))) + mytheme(24)
```
...
plot(estimate_relation(fit2, by = c("duration", "intensity=[sd]"))) + mytheme(24)
```
...
plot(estimate_relation(fit2, by = c("intensity", "duration=[sd]"))) + mytheme(24)
```
...
plot(estimate_relation(fit3, by = c("duration_c", "intensity_c=[sd]"))) + mytheme(24)
```
...
plot(estimate_relation(fit3, by = c("intensity_c", "duration_c=[sd]"))) + mytheme(24)
```
