...
## Example moderation questions {.fs70}
...
## Interpreting the Coefficients {.fs70}
...
## Plotting interaction effects {.fs90}
...
## Interpreting coefficients {.fs70}
...
## Simple and interaction effects {.fs70}
...
<!-- ==========================================================================
     DRAFT — three-way interactions. Written to address the note that 11b runs
     short. The statistical pedagogy here has NOT been reviewed by the course
     author; check the framing, the worked interpretations, and whether this
     belongs in 11b at all before teaching it.
     ========================================================================== -->

# Three-Way Interactions

## When two-way isn't enough {.fs70}
...
::: {.fragment .mt1}
- This is a [three-way interaction]{.b .blue}: moderation of a moderation
:::
:::
...
## Reading the output {.fs70}

- The coefficient table gets long fast (3 predictors gives 12 terms here)

::: {.fragment .mt1}
- Read it [top-down]{.b .blue}, highest-order term first
    + If the three-way term is significant, the two-way interactions
      *cannot* be interpreted on their own
...
## Probing: slopes by both moderators {.fs90}
...
## Does the sex gap shift with duration? {.fs90}
...
plot(predict_response(fit6, terms = c("duration", "sex", "program")))
```
...
plot(predict_response(fit6, terms = c("duration", "sex", "program"))) + mytheme(20)
```

## Proceed with caution {.fs70}
