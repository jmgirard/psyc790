...
::: {.columns .pv4}
::: {.column width="60%"}
- So far, *one* effect depended on *one* moderator
...
::: {.fragment .mt1}
- A [three-way interaction]{.b .blue}: moderated moderation
:::
:::
...
- Read it [top-down]{.b .blue}, highest-order term first
    + If the three-way term is significant, the two-way terms
      are not *overall* effects
