...
a) Report the estimated interaction coefficient and whether it is significant. In your own words, describe what this coefficient says about how the relationship between `fatalism` and `depression` changes as `simplicity` increases.{{< hp glyph="b" >}}

b) Explain why the `fatalism` coefficient in this model should **not** be described as "the effect of `fatalism`."{{< hp glyph="b" >}} What value of `simplicity` does it correspond to, and is that value plausible for anyone in this dataset?
...
b) Explain why centering changed the coefficients that it did.{{< hp glyph="b" >}} In the centered model, what does the `fatalism` coefficient now represent?
