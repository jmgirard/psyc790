...
plot(estimate_relation(fit3, by = "n_pubs")) + mytheme(18)
```
...
```{r, fig.width=5, fig.height = 3}
plot(estimate_relation(fit3, by = "yrs_since")) + mytheme(18)
```
:::
:::
...
```{r, fig.width=5, fig.height=3}
plot(estimate_relation(fit3, by = c("n_pubs", "yrs_since=[sd]"))) + mytheme(18)
```
:::
::: {.column}
...
```{r, fig.width=5, fig.height = 3}
plot(estimate_relation(fit3, by = c("yrs_since", "n_pubs=[sd]"))) + mytheme(18)
```
