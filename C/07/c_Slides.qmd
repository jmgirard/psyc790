...
::: {.footer}
These diagrams are a helpful picture, not an exact rule --- a partial effect can occasionally be *larger* than its zero-order effect, which no overlap diagram can draw
:::
...
::: {.fragment}
This suggests that the *shared variance* is doing a lot of work (especially for `bill_len`)
