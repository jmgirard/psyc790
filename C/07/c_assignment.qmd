...
a) The `type` coefficients differ between the two models -- one of them even changes sign. Explain why.{{< hp glyph="b" >}} Which set are zero-order effects and which are partial effects, and how does that change how you would describe them?
