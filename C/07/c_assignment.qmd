...
a) Report which partial effects are significant. Then explain why a predictor can be significantly correlated with the outcome on its own and yet have a non-significant partial effect once the other predictors are in the model.
