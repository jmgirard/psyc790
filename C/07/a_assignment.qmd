...
b) The intercept is the predicted value of `depression` when `fatalism` equals zero. Look at the range of the `fatalism` variable and comment on whether that intercept describes anyone who was actually measured.
